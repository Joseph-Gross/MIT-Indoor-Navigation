...
#       float
#     """
#     pointA = (first_point.lat,first_point.lon)
#     pointB = (second_point.lat,second_point.lon)
...
def calculate_direction(first_point, second_point):
    return math.degrees(math.atan2(second_point.lon - first_point.lon, second_point.lat - first_point.lat))
